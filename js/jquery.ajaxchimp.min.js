(function($){
	...
	$.ajaxChimp={
		responses:{
			...
			"Please enter a value":1,"An email address must contain a single @":2,
		...
		$.fn.ajaxChimp=function(options)
		{
			$(this).each(function(i,elem)
			{
				...
				form.submit(function(){var msg;function successCallback(resp)
					{
						if(resp.result==="success")
						{
							msg="We have sent you a confirmation email";
							label.removeClass("error").addClass("valid");email.removeClass("error").addClass("valid")
						}
						else{
							...
							try{
								...
								if(parts[1]===undefined){msg=resp.msg}
									else
									{
										...
										{
											index=parts[0];
											msg=parts[1]}else{index=-1;msg=resp.msg}
										}
									}
									catch(e){index=-1;msg=resp.msg}
								}
								if(settings.language!=="en"&&$.ajaxChimp.responses[msg]!==undefined&&
									$.ajaxChimp.translations&&$.ajaxChimp.translations[settings.language]&&
